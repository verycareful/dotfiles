...
if status is-interactive
    ...
    set -gx FZF_DEFAULT_OPTS '--height 40% --layout=reverse --border=sharp --color=bg+:#182036,fg+:#e4e8f4,hl:#ff8c32,hl+:#ff8c32,pointer:#ff8c32,prompt:#4b6fd6,border:#243052,info:#5d6784,marker:#5fc98a'
end
